...
Version  : 1.0.9
Release  : 63
URL      : https://cran.r-project.org/src/contrib/sf_1.0-9.tar.gz
Source0  : https://cran.r-project.org/src/contrib/sf_1.0-9.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667926382
