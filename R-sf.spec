...
Version  : 0.9.7
Release  : 37
URL      : https://cran.r-project.org/src/contrib/sf_0.9-7.tar.gz
Source0  : https://cran.r-project.org/src/contrib/sf_0.9-7.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1609949171
