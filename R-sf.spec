...
Version  : 0.9.0
Release  : 22
URL      : https://cran.r-project.org/src/contrib/sf_0.9-0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/sf_0.9-0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585149137
