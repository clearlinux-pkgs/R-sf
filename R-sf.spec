...
Version  : 1.0.7
Release  : 58
URL      : https://cran.r-project.org/src/contrib/sf_1.0-7.tar.gz
Source0  : https://cran.r-project.org/src/contrib/sf_1.0-7.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1646667652
...
/usr/lib64/R/library/sf/tests/testthat/testthat-problems.rds
